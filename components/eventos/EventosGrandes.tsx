...
function EventCard({ room }: { room: (typeof rooms)[number] }) {
  ...
  return (
    /* CORRECCIÓN PRINCIPAL: 
      Le asignamos una altura fija base en mobile (h-[480px]) para que la tarjeta 
      sea un bloque sólido. Al abrirse, la imagen pasa a 0 y los detalles toman 
      ese lugar EXACTO dentro de los mismos 480px, sin que la tarjeta se mueva.
      En pantallas grandes (sm:h-[460px]) mantiene tu diseño original de escritorio.
    */
    <article className="group flex flex-col overflow-hidden bg-white shadow-[0_24px_80px_rgba(0,0,0,0.06)] h-[480px] sm:h-[460px]">
      {/* Contenedor de la imagen (Volvemos al diseño limpio original) */}
      <div
      ...
      <div className="flex flex-1 flex-col px-7 pb-8 pt-7 sm:p-6">
        ...
        {/* Título (Dejamos el tuyo original ya que el problema no era este elemento) */}
        <h3
        ...
        {/* El truco del CSS Grid Dinámico que ya funcionaba bien */}
        <div
          ...
          <div className="overflow-hidden">
            <div className="border-y border-black/10 py-5">
              ...
              <div className="grid gap-4 text-[13px] text-black/60">
                ...
                <div className="flex items-center gap-3">
                  <Users size={15} />
                  <span>Coktail: {room.cocktail} personas</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Botonera fija al fondo gracias a mt-auto */}
        <div className="grid grid-cols-2 gap-3 pt-5 mt-auto sm:gap-4">
          <button
            type="button"
